-- ========================================
-- FORÇAR CORREÇÃO JÚLIO - DEFINITIVO
-- ========================================
...
-- PASSO 3: FORÇAR Júlio para o EXATO tenant_id da Maria
WITH maria_tenant AS (
    SELECT raw_user_meta_data->>'tenant_id' AS tenant_id
    FROM auth.users
    WHERE email LIKE '%maria%'
...
-- PASSO 7: Verificar leads fechados por tenant
SELECT 
...
-- PASSO 8: Verificar se há vendas em leads.fields
SELECT 
...
-- PASSO 9: Calcular total real (sales + fields)
...
-- 5. Agora Júlio deve ver o MESMO valor da Maria!
-- ========================================
