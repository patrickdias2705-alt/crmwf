-- =====================================================
-- ENCONTRAR DADOS REAIS - BUSCAR EM TODOS OS TENANT_IDS
-- =====================================================
-- Script para encontrar onde estão os dados reais
...
-- 2. Verificar leads por tenant_id (todos)
SELECT 
    tenant_id,
    COUNT(*) as total_leads,
...
-- 3. Verificar leads com tenant_id NULL
SELECT 
...
-- 4. Verificar leads com emails reais (todos os tenant_ids)
SELECT 
    tenant_id,
...
-- 6. Verificar leads mais antigos (últimos 90 dias)
SELECT 
    tenant_id,
...
-- 7. Verificar se existem leads com nomes reais (todos os tenant_ids)
SELECT 
    tenant_id,
