    ...
    try {
      ...
      if (metricsData) {
        ...
        const totals = metricsData.reduce((acc, day) => ({
          leads_received: acc.leads_received + day.leads_in,
          leads_attended: acc.leads_attended + day.leads_attended,
          leads_scheduled: acc.leads_scheduled + (day.qualified || day.booked || 0),
          leads_closed: acc.leads_closed + day.closed,
          leads_refused: acc.leads_refused + day.refused,
          leads_lost: acc.leads_lost + day.lost,
          conversion_rate: 0
        }), {
          leads_received: 0,
          leads_attended: 0,
        ...
        const chartDataFormatted = metricsData.map(day => ({
          ...
          leads: day.leads_in,
          attended: day.leads_attended,
          closed: day.closed
        }));
        setChartData(chartDataFormatted);
      }

      // Load leads data for sources and recent activity
