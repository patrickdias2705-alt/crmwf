...
export default function ListaGeral() {
  ...
  const fetchPublicLeads = async () => {
    try {
      ...
      console.log('📋 ListaGeral - Resultado da query:', { data, error, count });
      ...
      console.log('✅ ListaGeral - Leads carregados:', { 
        currentPage, 
  ...
  const handleEditSuccess = () => {
    fetchPublicLeads(); // Recarregar lista após edição
  };
  ...
  // Para simplificar, vamos usar os leads diretamente da paginação
  // Futuramente pode implementar filtros no servidor também
