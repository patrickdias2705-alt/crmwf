      ...
      <div className={`relative z-10 w-full max-w-md transition-all duration-500 ${
        ...
        <div className="text-center mt-6 animate-fade-in" style={{ animationDelay: '0.5s' }}>
          <p className="text-xs text-muted-foreground">
            Powered by <span className="bg-gradient-to-r from-primary via-accent to-secondary bg-clip-text text-transparent font-semibold font-display">WF Cirúrgicos Technology</span>
          </p>
        </div>
      </div>
    </div>
