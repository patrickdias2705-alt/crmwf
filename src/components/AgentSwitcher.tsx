...
export function AgentSwitcher() {
  ...
  // Ocultar botão para supervisores específicos - VERIFICAÇÃO PRIMÁRIA
  const supervisorEmails = ['julio@varejo.com', 'recebimento@varejo.com', 'supervisor@teste.com'];
  if (user?.email && supervisorEmails.includes(user.email)) {
    console.log('🚫 AgentSwitcher oculto para:', user.email);
    return null;
  }
  ...
  const handleSelectAgent = (agent: Agent) => {
    ...
    setViewingTenant(agent.tenant_id, agent.tenants.name, agent.id, agent.name);
