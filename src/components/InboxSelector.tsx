                        ...
                        <div className="relative">
                          {inbox.avatar_url ? (
                            <img 
                              ...
                              alt={inbox.name}
                              className="w-16 h-16 rounded-full shadow-lg hover:scale-110 transition-transform duration-300 ring-2 ring-green-400 object-cover"
                              onError={(e) => {
                          ...
                          <div 
                            className={`w-16 h-16 rounded-full bg-gradient-to-br from-green-500 to-green-600 flex items-center justify-center shadow-lg hover:scale-110 transition-transform duration-300 ring-2 ring-green-400 ${inbox.avatar_url ? 'hidden' : ''}`}
                          >
