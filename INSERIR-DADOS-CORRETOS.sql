-- =====================================================
-- INSERIR DADOS CORRETOS - APENAS COLUNAS EXISTENTES
-- =====================================================
-- Script que usa apenas as colunas que realmente existem na tabela metrics_daily

-- 1. Primeiro, verificar quais colunas existem na tabela metrics_daily
SELECT 
    column_name,
    data_type,
    is_nullable
...
-- 2. Inserir leads primeiro (que sabemos que funciona)
INSERT INTO leads (
    id,
    tenant_id,
    name,
...
-- 5. Tentar inserir na metrics_daily apenas com colunas básicas (se existir)
-- Primeiro vamos ver se conseguimos inserir apenas com tenant_id e date
